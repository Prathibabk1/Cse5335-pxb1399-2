...
csv
 ...
 .on("data", function(data){
    ...
    var query = client.query('Insert into d8t7da2vk0jima.items (unitid,instnm,addr,city,stabbr,zip) values($1,$2,$3,$4,$5,$6)',[d1.UNITID,d1.INSTNM,d1.ADDR,d1.CITY,d1.STABBR,d1.ZIP],function(err, result) {
