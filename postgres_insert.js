...
csv
 ...
 .on("data", function(data){
    ...
    var query = client.query('Insert into d8t7da2vk0jima.items (unitid,instnm,addr,city,stabbr,zip) values($1,$2,$3,$4,$5,$6)',[id,instn,add,city,st,zip],function(err, result) {
