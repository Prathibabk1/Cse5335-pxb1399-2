...
csv
 ...
 .on("data", function(data){
     console.log(data);
     var query = client.query("Insert into ITEMS (unitid,instnm,addr,city,stabbr,zip) values($1, $2, $3, $4, $5, $6)",[parseInt(UNITID),'uta','arlington','arling','tx','76010'],function(err, result) {
